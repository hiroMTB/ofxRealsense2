...
static void draw_pointcloud(float width, float height, glfw_state& app_state, rs2::points& points)
{
    if (!points)
        return;
...
static void register_glfw_callbacks(window& app, glfw_state& app_state)
{
